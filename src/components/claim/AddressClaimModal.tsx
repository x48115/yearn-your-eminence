...
export default function AddressClaimModal({ isOpen }: { isOpen: boolean }) {
  ...
  return (
    <Modal isOpen={true} maxHeight={90}>
        ...
        <ContentWrapper gap="lg">
          <ModalUpper>
            <CardSection gap="md">
              ...
              <TYPE.black fontWeight={700} fontSize={36}>
                <Center>{unclaimedAmount?.toFixed(0, { groupSeparator: ',' } ?? '-')} DAI</Center>
              </TYPE.black>
            </CardSection>
            <Break />
          </ModalUpper>
          <AutoColumn gap="md" style={{ padding: '1rem', paddingTop: '0' }} justify="center">
            <TYPE.subHeader fontWeight={500}>
              Enter an address to trigger a DAI claim. If the address has any claimable DAI it will be sent to them on
              submission.
            </TYPE.subHeader>
